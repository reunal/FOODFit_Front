        ...
        <div className="daily_page">
            ...
            <div className="classify_graph">
                <p className="description">
                    당신의 일일 적정 섭취량은 칼로리{" "}
                    {progressData.recommendedCaloriePerDay}kacl, 나트륨{" "}
                    {progressData.recommendedSaltPerDay}g, 단백질{" "}
                    {progressData.recommendedProteinPerDay}g, 지방{" "}
                    {progressData.recommendedFatPerDay}g 입니다.
                </p>
